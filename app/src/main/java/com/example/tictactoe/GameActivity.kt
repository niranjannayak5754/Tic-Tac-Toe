...
class GameActivity : AppCompatActivity(), View.OnClickListener {
    ...
    companion object {
        const val KEY_1 = "player1"
        const val KEY_2 = "player2"
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val player1Name = intent.getStringExtra(KEY_1)
        val player2Name = intent.getStringExtra(KEY_2)


        tvGameBattle.text = "$player1Name v/s $player2Name"
        "$player1Name's Turn".also { tvPlayer.text = it }
...
//        calling function onClick whenever the button is clicked
        ...
        connectMail.setOnClickListener() {
            val mail = Intent()
            mail.action = Intent.ACTION_SENDTO
            mail.data = Uri.parse("mailto: niranjannayak0717@gmail.com")
            startActivity(mail)
        }
    }
